"""
dbt Python staging model for China Medium Resolution PV 2024 dataset.
...
def model(dbt, session):
    """
    Staging model for China Medium Resolution PV 2024.
    ...
    print("🚀 dbt Python staging: Processing China Medium Resolution PV 2024 with spatial processing...")
    ...
    results = dr.execute(final_outputs, 
                       inputs={'dataset_names': 'chn_med_res_pv_2024'})
