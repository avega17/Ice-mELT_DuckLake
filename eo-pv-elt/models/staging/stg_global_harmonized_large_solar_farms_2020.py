"""
dbt Python staging model for Global Harmonized Large Solar Farms 2020 dataset.
...
Flow:
1. Load raw table from DuckLake catalog
...
Uses Arrow zero-copy for efficient data exchange between Hamilton, Ibis, and pandas.
"""

def model(dbt, session):
    """
    Staging model for Global Harmonized Large Solar Farms 2020.
    ...
    print("🚀 dbt Python staging: Processing Global Harmonized Large Solar Farms 2020 with spatial processing...")
    ...
    config = {
        'dataset_name': 'global_harmonized_large_solar_farms_2020',
    ...
    results = dr.execute(final_outputs, 
                       inputs={'dataset_names': 'global_harmonized_large_solar_farms_2020'})
