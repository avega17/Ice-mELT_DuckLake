"""
dbt Python staging model for UK Crowdsourced PV 2020 dataset.
...
def model(dbt, session):
    """
    Staging model for UK Crowdsourced PV 2020.
    ...
    print("🚀 dbt Python staging: Processing UK Crowdsourced PV 2020 with spatial processing...")
    ...
    results = dr.execute(final_outputs, 
                       inputs={'dataset_names': 'uk_crowdsourced_pv_2020'})
